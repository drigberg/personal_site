...
var Fish = function(x, y){
    ...
    this.turnTowards = function(target) {
        ...
        if (target.x != null && target.y != null) {
            let distanceToTarget = findDistance(this.x + this.width / 2, this.y + this.height / 2, target.x + target.width / 2, target.y + target.height / 2);
            ...
            var unitVectorToTarget = findUnitVector(this.x + this.width / 2, this.y + this.height / 2, target.x + target.width / 2, target.y + target.height / 2);
    ...
    this.update = function(){
        ...
        for (var i = 0; i < fishFoods.length; i++) {
            if (fishFoods[i] != null) {
                let newDistance = findDistance(this.x + this.width / 2, this.y + this.height / 2, fishFoods[i].x + fishFoods[i].width / 2, fishFoods[i].y + fishFoods[i].height / 2);
...
var FishFood = function(x, y) {
    ...
    this.loadImage = function() {
        this.image = loadImage("../assets/photos/fishy/sociomantic.png", function(img) {
                img.resize(30, 30);
        });
    };
